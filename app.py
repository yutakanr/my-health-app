...
if selected_user != "選択してください":
    ...
    try:
        ...
        st.info(f"✨ 今月のシート「{target_sheet}」を新しく作成するね！")
    ...
    if not data.empty:
        ...
        chart = {
            ...
            "encoding": {
                ...
                "y": {"field": "スコア", "type": "quantitative", "scale": {"domain": [0, 10]}, "axis": {"tickCount": 11, "title": "スコア / 時間"}},
            ...
            "config": {"selection": {"manual_zoom": {"type": "interval", "bind": "scales", "zoom": False, "translate": False}}}
        }
